...
<div class="col-lg-12">
												...
												<div class="row">
													<div class="col-6">
														<ul class="post-tags">
															...
															if ( $posttags ) {
																foreach ( $posttags as $tagi ) {
																										echo '<li><a>'.$tagi->name .'</a>,</li>'; 
																}
															}
															?>
														</ul>
		...
		foreach ( $recent_posts as $post1 ) :
			?>
											...
											<ul>
												<li><a href="<?php echo get_permalink( $post1[ 'post_title' ] ); ?>">
													<h5><?php echo $post1['post_title'] ?></h5>
													<span><?php echo $post1['date'] ?></span>
												</a>
										</li>
